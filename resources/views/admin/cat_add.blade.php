                                 ...
                                 <div class="col-sm-6">
                                    <div class="form-group">
                                       <div class="controls">
                                          ...
                                          <input id="catname" type="text" name="name" value="{{ old('name') }}" class="form-control" placeholder="Cat Name" required data-validation-required-message="This Cat Name field is required">
                                       </div>
                                        @error('name')
